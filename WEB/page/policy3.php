...
?>
	<div id="main_container">
		<div class="path"><div class="container_inner pd44"><span>홈 > </span><strong>위치기반 서비스이용약관</strong></div></div>
		<div class="container_inner">
			<div class="contents">
				<div class="tit">위치기반 서비스이용약관</div>
				<textarea class="usebox">
					제1장 총칙제 1 조 (목적)
본 약관은 회원(탈출러 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.)이 이놀루션(이하 "회사"라고 합니다.)이 제공하는 탈출러 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
제 2 조 (이용약관의 효력 및 변경)
•	① 본 약관은 서비스를 신청한 고객 또는 개인위치정보주체가 본 약관에 동의하고 회사가 정한 소정의 절차에 따라 서비스의 이용자로 등록함으로써 효력이 발생합니다.
•	② 회원이 온라인에서 본 약관 "동의하기" 버튼을 클릭하였을 경우 또는 오프라인 업체에서 서비스 이용 시 탈출러 앱 내 본 약관의 "동의하기" 버튼을 클릭하여 서비스를 이용한 경우, 본 약관의 내용을 모두 읽고 이를 충분히 이해하였으며, 그 적용에 동의한 것으로 간주합니다.
...
서비스 명	서비스 내용
탈출러 서비스	위치정보수집 대상의 실시간 위치확인
이용자의 위치에서 근접한 업소정보제공
오프라인 혜택존 서비스	○ 정상 이용 판단을 위한 단말기 위치정보수집
○ 이용자에게 서비스 이용 혜택 제공
제 5 조 (서비스 이용요금)
...
o	1. 회원이 회사 서비스의 운영을 고의 또는 중과실로 방해하는 경우
...
o	1. 개인위치정보를 수집한 당해 통신단말장치가 문자, 음성 또는 영상의 수신기능을 갖추지 아니한 경우
o	2. 회원이 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우
제 9 조 (개인위치정보주체의 권리)
...
o	1. 본인에 대한 위치정보 수집, 이용, 제공사실 확인자료
o	2. 본인의 개인위치정보가 위치정보의 보호 및 이용 등에 관한 법률 또는 다른 법률 규정에 의하여 제3자에게 제공된 이유 및 내용
...
o	1. 위치정보 및 위치기반서비스 제공에 따른 요금정산을 위하여 위치정보 이용, 제공사실 확인자료가 필요한 경우
o	2. 통계작성, 학술연구 또는 시장조사를 위하여 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우
...
o	1. 8세 이하의 아동
o	2. 금치산자
o	3. 장애인복지법제2조제2항제2호의 규정에 의한 정신적 장애를 가진 자로서장애인고용촉진및직업재활법 제2조제2호의 규정에 의한 중증장애인에 해당하는 자(장애인복지법 제29조의 규정에 의하여 장애인등록을 한 자에 한한다)
...
o	3. 회원의 귀책사유로 서비스 이용에 장애가 있는 경우
o	4. 제1호 내지 제3호를 제외한 기타 회사의 고의∙과실이 없는 사유로 인한 경우
...
•	1. 상 호 : 이놀루션
•	2. 대 표 자 : 최 연 진
•	3. 주 소 : 서울특별시 강동구 길동 247번지
•	4. 대표전화 : 1566-0280
제1장 총 칙제1조 (시행일)
이 약관은 2017년 02월부터 시행한다.
제2조 위치정보관리책임자
위치정보관리책임자는 2017년 02월을 기준으로 다음과 같이 지정합니다.
•	1. 소 속 : 탈출러
•	2. 성 명 : 최연진
•	3. 연락처 : 1566-0280
