...
<div id="wrap">
	<header id="header">
		<div class="header_inner">
			...
			<a href="#n" class="btn_back" id="btn_back_go"><img src="../images/btn/btn_back.png" alt="" /></a>
<script>
function goback(){
history.back();
}
/*아이폰의 경우, 페이지 이동 시, fulse값을 반환하지 않아 history.back()을 사용하면 작동하지 않음, 때문에 아래 코드를 이용하여 모바일에서 사용할 수 있는 범용 뒤로가기 버튼을 사용한다*/
$(document).ready(function(){    
	$('#btn_back_go').click(function(){        
		parent.history.back();        
		return false;    
	});
});
