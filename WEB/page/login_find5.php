...
<div id="wrap">
	...
	<div id="main_container">
		...
		<div class="container_inner">
			<div class="loginarea">
				<div class="tit"><span>비밀번호 찾기</span><div class="lfind"><span>01. 아이디입력 ></span><span>02. 본인 확인 ></span><strong>03. 비밀번호 재설정</strong></div></div>
				<div class="graybox find">
					<div class="ftit">새로 사용 할 비밀번호를 입력해주세요.<br />사용하시던 비밀번호는 탈출러도 알 수 없습니다.<br />비밀번호를 새로 설정해 주세요.</div>
					<div class="topbox">
						<div class="inputbox">
							<input type="password" class="txt st04" placeholder="새 비밀번호를 입력해주세요. ( 영문,숫자 포함 6~20자 )" />
						</div>
						<div class="inputbox">
							<input type="password" class="txt st04" placeholder="비밀번호를 한번 더 입력하세요." />
						</div>
					</div> 
					<div class="bottombox">
						<div class="autoimg">
							<p>아래 이미지를 보이는대로 입력해주세요.</p>
							<dl class="">
								<dt>이미지</dt>
								<dd class="new"><a href="#">새로고침</a></dd>
								<dd><a href="#">음성으로 듣기</a></dd>
							</dl>
							<input type="text" class="txt st05" placeholder="자동방지 입력 문자" />
						</div>
					</div>
				</div>
				<div class="nextarea">
					<a href="#" class="btn_com">확인</a>
				</div>
			</div>
		</div>
	</div>
