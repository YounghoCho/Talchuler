...
<form action="./gameAdmit.php" method="POST">
...
?>
		...
		<tr>
			<td id="subtitle" colspan="3" style="width:700px; height:50px;">
		...
		<tr>
			<td id="content" rowspan="3" style="background-color:#eeeeee; width:30%;">
			...
			<td id="summary" style="background-color:#eeeeee; width:30%; height:30%;">
	...
	<input type="button" class="dnyBtn" value="거절" onclick="deleteGame()">
	<input type="submit" class="acpBtn" value="승인하기">
</div>
</form>
