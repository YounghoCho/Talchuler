...
<div id="Main">
	...
	<div id="Main_content_area">
		<div id="Page_info">
			<div class="left">
				<div class="page_count"><a href=" "><</a></div>
				<div class="page_count">2</div>
				<div class="page_count">/</div>
				<div class="page_count">13</div>
				<div class="page_count"><a href=" ">></a></div>
			</div>
			<div class="right">
				<div class="time_info">17.04.06 오후 7:00 제출됨</div>
			</div>
		</div>
		<div id="cafe_information">
			<div class="cafe_info">
				...
				<div class="name">
					...
					<div class="sub">02 - 3333 - 3333</div>
				</div>
				<div class="name">
					<div class="logo_area">
					...
					<div class="sub">서울특별시 OOO구 OO로 OO길 OOOO빌딩 O층 OOO호</div>
				</div>
				<div class="name">
					<div class="logo_area">
					...
					<div class="sub">모든테마 탈출시,폴라로이드 사진 촬영</div>
				</div>
			</div>
		</div>
		<div id="clickbox_area">	
			<div id="clickbox_house">
				<a href=" "><div class="gray">거절</div></a>
				<div class="empty_space">&nbsp</div>
				<a href=" "><div class="rightblue">승인하기</div></a>
			</div>
		</div>
		<div id="promise">
