...
<!--여기서부터 메인페이지를 자유롭게 작성하면 됩니다.-->
	<div>
		...
		<br>
		<center><button class="btn_bottom" onclick="location.href='./register1.php'">이전</button>
		<button class="btn_bottom" onclick="location.href='./register3.php'">다음</button></center>
		<br><br>
	</div>
