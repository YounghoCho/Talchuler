...
<div id="Main">
	<div id="Main_container">
		<div id="Main_titlebar">
			...
			<div class="anything">&nbsp</div>
			<div class="subtitle">회원정보에 등록한 휴대전화 번호와 같아야 인증번호를 받으실 수 있습니다.</div>
		</div>
		<form action="url" id="inputbox">
			<div class="container">
				<div class="major">이&nbsp&nbsp&nbsp&nbsp&nbsp름</div>
				<input name="uesr_name" placeholder="  이름을 입력하세요."> <br>
			</div>
			<div class="container_phone">
				...
				<div class="need_bar">&nbsp</div>
				<input type="text" name="phone_number" placeholder="  휴대전화번호">
				<div class="click_box">
			...
			<div class="help_icon">
				<img src="images\icon\icon_facebook.png" title="대대롱은 멋지다.&#13;대대롱은 잘생겼다.&#13대대롱은 섹시하다&#13대대롱은 치명적이다.&#13조으디" />
			</div>
		</form>
		<div id="clickbox_area">
			<div id="clickbox_house">
				<div class="gray1"><a href=" ">이전</a></div>
				<div class="empty_space">&nbsp</div>
				<div class="gray2"><a href=" ">다음</a></div>
			</div>
		</div>
	</div>
</div>
