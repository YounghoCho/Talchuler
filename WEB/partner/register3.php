...
<div>
	<table class="member">
		...
		<td class="right">1.약관 동의 > 2.회원정보입력 > <b>3.가입완료</b></td>
		</tr>
	</table>
</div>
<div class="ment">
...
<div>
	...
	<tr>
		...
		<td colspan="2">
			<input type="text" value="제목" onfocus="this.value=''" style="width:100%; height:100%; background-color:#F2F2F2">
		</td>
	</tr>
	<tr>
		<td colspan="2" style="height:10%">
			<input type="text" value="부제목" onfocus="this.value=''" style="width:100%; height:100%; background-color:#F2F2F2">
		</td>
	</tr>
	<tr>
		<td rowspan="5" width="30%">
		<textarea name="text" onfocus="this.value=''" style="width:100%; height:100%; background-color:#F2F2F2; overflow-invisible;">게임설명을 입력해주세요</textarea>
		</td>
		<td>
	...
	<tr>
		<td>
		<textarea class="color" id="clr" style="width:100%; height:100%; background-color:#F2F2F2;" onfocus="this.value=''">게임요약 설명을 입력해주세요
(미입력시 게임설명 처음4줄 등록)</textarea>
		</td>
	</tr>
	<tr>
		<td height="5%">
