...
#Main_title_area{
	/*padding-left 크기 뺴줌*/
	width : -webkit-calc(100% - 59px); /* for Chrome, Safari */
    width :    -moz-calc(100% - 59px); /* for Firefox */
    width :         calc(100% - 59px); /* for IE */
	overflow:auto;
	margin:50 0 0 33;
	padding:0 0 30 26;
}
...
#Main_datechoice_area{
	/*padding-left 크기 뺴줌*/
	width : -webkit-calc(100% - 53px); /* for Chrome, Safari */
    width :    -moz-calc(100% - 53px); /* for Firefox */
    width :         calc(80% - 53px); /* for IE */
	overflow:auto;
	margin:0 0 0 33;
	padding:0 0 30 26;
}
...
#Main_content_area{
	/*padding-left 크기 뺴줌*/
	overflow:auto;
	width : -webkit-calc(80% - 63px); /* for Chrome, Safari */
    width :    -moz-calc(80% - 63px); /* for Firefox */
    width :         calc(80% - 63px); /* for IE */
	margin:0 0 0 33;
	padding:15 0 0 26;
}
