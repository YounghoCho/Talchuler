	...
	<div class="Main" id="Main">
		<div class="MainBanner">
			<div class="mySlides fade">
			  <img src="./images/banner/banner_topA.png" style="width:100%;cursor:pointer" onclick="popup()">
			</div>
			<div class="mySlides fade">
			  <img src="./images/banner/banner_topB.png" style="width:100%;cursor:pointer">
			</div>
			<div class="mySlides fade">
			  <img src="./images/banner/banner_topC.png" style="width:100%;cursor:pointer" onclick="location.href='./banner_lowest.html'">
			</div>
		</div>
