			...
			<div class="inputbox">
				<form action="./register3.php" id="inputbox" name="register2form" method="POST">
					...
					<div class="container">
						...
						<input type="text" maxlength="16" style="padding-left:5px;" name="id" id="id" placeholder="아이디를 입력해주세요">
						<input type="button" onclick="pass_pid()" value="중복확인" style="font-weight:bold;padding:2px 3px 2px 3px;margin-left:10px;width:80px;background-color:#56DCFC;border:none;" >
						<br>
					</div>
...
function pass_pid(){
	...
	location.href='./id_check.php?p_id='+pass;
}
</script>